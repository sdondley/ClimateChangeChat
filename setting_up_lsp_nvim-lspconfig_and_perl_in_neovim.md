...
**PREFACE**: I was pretty much clueless about language servers and using them with neovim until recently. It took a few days of fiddling and trial and error to get somewhat of a clue. But it's actually surprisingly easy to get set up. This tutorial is the tutorial I wish I existed to save me some time. Good luck! 

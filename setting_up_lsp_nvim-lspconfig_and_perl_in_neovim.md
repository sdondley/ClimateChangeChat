...
**PREFACE**: I was pretty much clueless about language servers and using them with neovim until recently. It took many hours of fiddling and experimenting to get somethings of a clue. But it's actually surprisingly easy to get set up. This tutorial is the tutorial I wish I existed when I started. Good luck! 

...
**DISCLAIMER**: This isn't meant to be exhaustive or the be all and end all authority of using Perl language servers with neovim. It's meant to save you some time and frustration. When in doubt, [RTFM](#rtfm).

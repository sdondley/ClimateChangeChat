...
**PREFACE**: I knew next to nothing about language servers or using them with neovim until recently. It took many hours of fiddling and experimenting to get something of a clue. But it turns out to be surprisingly easy to set up a Perl language server with neovim. This tutorial is the tutorial I wish I existed when I started and should spare you some confusion and frustration. Good luck! 
